...
export class DataService {
  ...
  registrar(usuario: JSON) {
    ...
    return this.response.post(this._API_ROOT + "/registro", usuario, {
      headers,
    });
  }
  iniciarSesion(dataQuery: JSON) {
    ...
    return this.response.post(this._API_ROOT + "/iniciarSesion", dataQuery, {
      headers,
    });
  }
  ...
  getEmociones(id) {
    ...
    console.log(
      this._API_ROOT + "/filtrarEstudiante" + "?identification =" + id
    );
